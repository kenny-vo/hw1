(function($){
	...
	$(document).ready( function(){
			$('.et_pb_module_0 ').on("click",function(){
			   $('.et_pb_toggle_content_0').toggle();
			});
			$('.et_pb_module_1').on("click",function(){
			 $('.et_pb_toggle_content_1').toggle();
			});
			$('.et_pb_module_2').on("click",function(){
			$('.et_pb_toggle_content_2').toggle();
			});
			$('.et_pb_module_3').on("click",function(){
			$('.et_pb_toggle_content_3').toggle();
			});

...
__twttrlr(function(using, provide, loadrunner, define) {
	...
	provide("tfw/widget/base", function(a) {
		using("util/util", "util/domready", "dom/get", "util/querystring", "util/iframe", "util/typevalidator", function(b, c, d, e, f, g) {
			...
			b.aug(m.prototype, {
				...
				for (; e = a[f]; f++) for (k in b) if (b.hasOwnProperty(k)) {
	...
	provide("anim/transition", function(a) {
		function b(a, b) {
			var c;
			return b = b || window, c = b.requestAnimationFrame || b.webkitRequestAnimationFrame || b.mozRequestAnimationFrame || b.msRequestAnimationFrame || b.oRequestAnimationFrame ||
			function(c) {
			...
			v.prototype = new b, k.aug(v.prototype, {
				setupSandbox: function(a) {
					var b = a.doc,
						...
						g = "#twitter-widget-0{width:100%; min-width:100%; max-width:100%} div.newsUpdates img.u-photo {display: none}   .header{display:none} div.var-chromeless li.tweet{color:#f2f2f2; padding-left:0; border-top:1px solid #f2f2f2} div#twitter-widget-0.root div.stream ol.h-feed li.tweet a.u-url {float:left; display:inline; text-align:left} div.var-chromeless li.tweet .expand {display:none} div.var-chromeless li.tweet .footer {display:none} div.var-chromeless li.tweet a:hover{color: #f2f2f2;text-decoration: underline;} div#twitter-widget-0.root div.timeline-header{display:none}",
						h = this,
						i;
